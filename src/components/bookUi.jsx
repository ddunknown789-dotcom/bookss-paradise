...
export const I = {
  ...
  back: (p) => (<svg viewBox="0 0 24 24" {...p}><path d="M20 12H5M11 6l-6 6 6 6" /></svg>),
  ...
  pen: (p) => (<svg viewBox="0 0 24 24" {...p}><path d="M4 20h4L19 9a2.8 2.8 0 0 0-4-4L4 16z" /><path d="m14 6 4 4" /></svg>),
  ...
  shield: (p) => (<svg viewBox="0 0 24 24" {...p}><path d="M12 3 4 6v6c0 5 3.5 8 8 9 4.5-1 8-4 8-9V6z" /></svg>),
  eye: (p) => (<svg viewBox="0 0 24 24" {...p}><path d="M2 12s3.6-6 10-6 10 6 10 6-3.6 6-10 6-10-6-10-6z" /><circle cx="12" cy="12" r="2.6" /></svg>),
  book: (p) => (<svg viewBox="0 0 24 24" {...p}><path d="M4 5.5A2.5 2.5 0 0 1 6.5 3H19v15H6.5A2.5 2.5 0 0 0 4 20.5z" /><path d="M12 4v14" /></svg>),
...
export function BookTopBar({ crumbs }) {
  return (
