  ...
  return (
    <section className="videos card" id="trailers" ref={root}>
      <div className="videos-head section-head">
        <p className="videos-kicker">Explore Our Video Content</p>
        <Divider width={300} />
        <h2 className="section-title">Stories Brought to Life</h2>
        <p className="videos-sub">
          Dive deeper into the books you love through our immersive video content.
        </p>
      </div>

      <div className="videos-grid">
        {CATEGORIES.map((c) => {
          const Badge = Icon[c.icon]
          return (
