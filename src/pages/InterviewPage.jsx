...
const Icon = {
  back: (p) => (<svg viewBox="0 0 24 24" {...p}><path d="M19 12H6M11 6l-6 6 6 6" /></svg>),
  bookmark: (p) => (<svg viewBox="0 0 24 24" {...p}><path d="M6 4.5A1.5 1.5 0 0 1 7.5 3h9A1.5 1.5 0 0 1 18 4.5V21l-6-3.6L6 21z" /></svg>),
  share: (p) => (<svg viewBox="0 0 24 24" {...p}><circle cx="18" cy="5" r="2.6" /><circle cx="6" cy="12" r="2.6" /><circle cx="18" cy="19" r="2.6" /><path d="m8.3 10.7 7.4-4.4M8.3 13.3l7.4 4.4" /></svg>),
  clock: (p) => (<svg viewBox="0 0 24 24" {...p}><circle cx="12" cy="12" r="8.5" /><path d="M12 7.8v4.65l3.1 1.85" /></svg>),
  calendar: (p) => (<svg viewBox="0 0 24 24" {...p}><rect x="3.5" y="5" width="17" height="15.5" rx="2" /><path d="M3.5 9.5h17M8 3v4M16 3v4" /></svg>),
  chevron: (p) => (<svg viewBox="0 0 24 24" {...p}><path d="m6 9 6 6 6-6" /></svg>),
}

export default function InterviewPage({ item }) {
      ...
      <main className="iv-main">
        ...
        <div className="iv-grid">
          ...
          <aside className="iv-profile">
            ...
            <p className="iv-role">
              Author of <a href={bookHref(item.book)}>{item.bookTitle}</a>
            </p>
