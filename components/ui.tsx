...
// Pure presentation, no hooks — safe in both server and client components.

export function Star4({ size = 16, color = '#C9962F' }: { size?: number; color?: string }) {
  return (
...
export function Divider({ align = 'center', width = 340 }: { align?: 'center' | 'left'; width?: number }) {
  return (
...
export function Sparkle({ className, size = 18, delay = 0 }: { className?: string; size?: number; delay?: number }) {
  return (
